...
const OneProduct = ({ id, productPictures, price }) => {
  ...
  <div className="flex mx-auto overflow-hidden relative justify-end cursor-pointer capitalize grid-col rounded-md w-56 h-80 mb-16 object-cover text-white  hover:shadow-2xl bg-black bg-opacity-50 group-hover:opacity-75 transition duration-300 ease-in-out">
