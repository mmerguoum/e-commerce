...
<nav className="bg-white border-gray-200 p-8 sm:px-4 py-2.5 rounded">
  ...
  <div className="flex md:order-2">
    <button type="button" className=" mr-10 block py-2 pr-4 pl-3 bg-gray-700 rounded md:bg-transparent md:text-yellow-600 md:p-0 dark:text-yellow-600">Login</button>
